...
void Account::_displayTimestamp(void)
{
	...
	tm_ptr = localtime(&t);
	cout << "[" << (tm_ptr->tm_year
		+ 1900) << setw(2) << setfill('0') << tm_ptr->tm_mon
		+ 1 << setw(2) << setfill('0') << tm_ptr->tm_mday << "_" << setw(2) << setfill('0') << tm_ptr->tm_hour << setw(2) << setfill('0') << tm_ptr->tm_min << setw(2) << setfill('0') << tm_ptr->tm_sec << "] ";
}
